...
class UserValidators:
    ...
    @staticmethod
    def validate_password_strength(password: str, locale: str = "en", i18n_service: I18nService = None) -> None:
    ...
    @staticmethod
    def validate_username_unique(username: str, user_id: str = None, locale: str = "en", 
    ...
    @staticmethod
    def validate_email_unique(email: str, user_id: str = None, locale: str = "en", 
                             db_service: DatabaseService = None, i18n_service: I18nService = None) -> None:
    ...
    @staticmethod
    def validate_user_update(user_update: UpdateUser, user_id: str, locale: str = "en", 
                           db_service: DatabaseService = None, i18n_service: I18nService = None) -> None:
    ...
    def validate_password_update(password_update: UpdatePassword, current_hashed_password: str, 
                               pwd_context, locale: str = "en", i18n_service: I18nService = None) -> None:
