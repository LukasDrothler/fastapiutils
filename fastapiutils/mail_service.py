...
class MailService:
    ...
    def _render_template(
        ...
        _config = {
            ...
            "container_background": self.colors["container_background"],
            ...
            "footer_border_color": self.colors["footer"]["border"],
            "footer_link_color": self.colors["footer"]["link"],
            "warning_background": self.colors["warning"]["background"],
            "warning_text_color": self.colors["warning"]["text"],
            "warning_border_color": self.colors["warning"]["border"],
            "warning_title_color": self.colors["warning"]["title"],
            "success_background": self.colors["success"]["background"],
            "success_text_color": self.colors["success"]["text"],
            "success_border_color": self.colors["success"]["border"],
            "error_background": self.colors["error"]["background"],
            "error_text_color": self.colors["error"]["text"],
            "error_border_color": self.colors["error"]["border"],
            "info_background": self.colors["info"]["background"],
            "info_text_color": self.colors["info"]["text"],
